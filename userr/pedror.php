                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" minlength="10" placeholder="Código de Validación" type="password" required="true">
                  </div>
                  <div class="text-muted font-italic"><small><span class="text-success font-weight-800" style="font-size:15px;"><a><u>Clic Aquí para solicitar un código de validación</u></a></span></small></div>
                </div>

...
<body class="bg-default" style="background: #f5f5f5 url(../assets/img/bg.png) left top repeat;">
  <div class="main-content">
    ...
    <div class="container mt--8 pb-5">
      <!-- Table -->
      <div style="margin-top: 15%;" class="row justify-content-center">
        <div class="col-lg-6 col-md-8">
          <div  class="card bg-secondary shadow border-0">
           
            <div class="card-body px-lg-5 py-lg-5" style="margin-top:20%;">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" minlength="3" maxlength="8" id="username" name="username" placeholder="Usuario" type="text" onkeypress="return idet(event)" value="<? echo $usern ?>" required="true">
                  </div>
                </div>
    ...
    margin-left: 0;
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input style="width:100% !important;" class="form-control" minlength="8"  type="tel" id="telif" name="cel" required="true">
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" minlength="8" id="promotor" name="promotor" placeholder="Patrocinador" type="text" onkeypress="return idet(event)" value="<? echo $usern ?>" required="true">
                  </div>
                </div>

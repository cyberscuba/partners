                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" minlength="4" maxlength="8" id="username" name="username" placeholder="Usuario" type="text" onkeypress="return idet(event)" value="<? echo $usern ?>" required="true">
                  </div>
                </div>

...
$query = $conectar->_db->query("SELECT ID,username,name_user,ape_user FROM security_users WHERE ID = $user");
$arrque = mysqli_fetch_array($query);
$isd = $arrque[ID];
$nom = $arrque['name_user'] . " " . $arrque['ape_user'];
$nomb = $arrque[username];


$nom1 = $nomb;
$extencion = substr($nom, -3);
$url = $nom1 . ".php";
$titulo = $url;
$idu = $isd;
$nuevoarchivo = fopen("userr/" . $titulo, "w+");
fwrite($nuevoarchivo, '<?php ');
fwrite($nuevoarchivo, ' $user = ');
fwrite($nuevoarchivo, $idu);
fwrite($nuevoarchivo, ' ?>');
fwrite($nuevoarchivo, '<?php  
        ...
        <div class="col-lg-6 col-md-8">
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              <div align="center"><img style="width:150px;" src="../assets/img/brand/logo.png" />
             <span class="nav-link-inner--text">Invitador por: <b style="font-size:20px;"><?php echo $name_user ?></b></span></div>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                 <input type="hidden" name="promotor" id="promotor" value="<?php echo $usern ?>">
                  <input type="hidden" name="posicion" id="posicion" value="Derecha">
                  <div class="input-group input-group-alternative mb-3">
                    <div class="input-group-prepend">

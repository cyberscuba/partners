          ...
          <div class="card-header border-0">
            <form action="" method="post" class="row align-items-center">
              ...
              <div class="input-group mb-3 col-lg col-sm-12" style="margin-top:7px;">
                ...
                <input id="filtUs" type="text" name="filtUs" value="<?php if (isset($_POST["filtUs"])) {
      echo $_POST["filtUs"];
              ...
              <div class="input-group mb-3 col-lg col-sm-12" style="margin-top:7px;">
                ...
                <input type="text" id="filtEmail" name="filtEmail" value="<?php if (isset($_POST["filtEmail"])) {
      echo $_POST["filtEmail"];
  } ?>" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
              </div>
              ...
              <div class="input-group mb-3 col-lg col-sm-12" style="margin-top:7px;">
                ...
                <select name="taskOption" class="custom-select" id="filEstado">
                  <option value=""></option>
                  <option value="1" <?php if ($_POST["taskOption"] == '1') {
      echo "selected";
  } ?>>Activo</option>
                  <option value="0" <?php if ($_POST["taskOption"] == '0') {
      echo "selected";
  } ?>>Inactivo</option>
                </select>
              </div>
              ...
              <table id="grid" style="width: 100%;" class="table-striped table-bordered dt-responsive ">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col">Puntos Calculados</th>
                ...
                <tbody>
                  <?php
                  $usdep = $_POST["filtUs"];
                  $corre = $_POST["filtEmail"];
                  $art = $Muestra->refersactus_admin($user, $usdep, $corre);
                  $index = 0;
                  $plani = 0;
                  while ($tl = mysqli_fetch_array($art)) {
                      ...
                      //print_r($tl["points"]);
                      //die('CAMS');
                      $pointsAdminAssigned = 0;
                      $calculatePoints = $Muestra->getTotalPoints($total_referidos[0], $pk['val_usd'], $tl["points"]);
                    ...
                    <tr>
                      ...
                      <?php if ($tl[ID] != 1) { ?><td>
                          <form method="POST" action="blkok_admin_user">
                            <input type="hidden" name="us_actva" id="us_actva" value="<?php echo $tl[ID] ?>" require="true">
                ...
                <h2 align="center">Total Gestionado:
                  <?php echo number_format($plani) ?> USD</h2><br>
              </table>
